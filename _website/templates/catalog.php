      ...
      <div class="FiltersDiv">
		...
		<div class="col-sm-4 ShowForMobile">
			<div class="HtmlMultiSelect">
				<div class="TItle"></div>
				<select multiple id="mobile-categories">
					<option selected disabled><?=l("searchbycategories")?></option>
          <?php foreach($g_categories_with_tour_count as $item): ?>
		...
		<div class="col-sm-4 ShowForMobile">
			<div class="HtmlMultiSelect">
				...
				<select multiple id="mobile-regions">
					...
					<?php foreach($g_places_with_tour_count as $item): ?>
          <option value="<?=$item['id']?>"><?=$item['title']?></option>
          <?php endforeach; ?>
				</select>
			</div>
          ...
          <div class="col-sm-3 HideForMobile">
            ...
            <div class="SearchResultText"><?=l("searchresult")?>: <span><?=(isset($items[0]["counted"])) ? $items[0]["counted"] : 0?></span></div>
          </div>
        ...
        if(scroll){
            ...
            $.ajax({
                ...
                if(obj.Error.Code==1){            
                    ...
                    $(".ToursList .row").append(obj.Success.Html);
                }
                scroll = true;
            });
        }
